			...
			<div class="ja-tab-subcontent">
				...
				<div id="page">
					<ul> 
						...
						<c:if test="${currentPage!=1 }">
							<li><a href="productListByCidServlet?cid=${cid }&currentPage=${currentPage-1}">《</a></li>
						</c:if>
						<c:forEach var="page" begin="1" end="${pages }">
							<c:if test="${page==currentPage }">
								<li><font style="font-size: 18px;color: red"><a href="productListByCidServlet?cid=${cid }&currentPage=${page}">${page }</a></font></li>
							</c:if>
							<c:if test="${page!=currentPage }">
							<li><a href="productListByCidServlet?cid=${cid }&currentPage=${page}">${page }</a></li>
								</c:if>
						</c:forEach>
