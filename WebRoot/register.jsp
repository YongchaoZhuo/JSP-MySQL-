			...
			<div id="mr-content" class="mr-content col-xs-12">
				<div class="login-wrap" style="margin-bottom: 60px; margin-top: 50px">
					<div style="max-width: 540px; margin: 0 auto;">
						<a href="index.jsp" title="点击返回首页"><img src="images/logo.png" width="120px" height="70px"></a>
					</div>
					<div class="login">
						...
						<!-- 会员注册表单 -->
						<form id="member-registration" action="registerServlet"
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-sm-8" style="clear: none;">
										<!-- 联系电话文本框 -->
										<input type="text" name="telephone" class="validate-email " id="tel"
								...
								<div class="form-group">
									<div style="float: right; padding-right: 216px;">
										YC商城<a href="" style="color: #0885B1;">《使用条款》</a>
									</div>
								</div>
								<div class="form-group">
